    ...
    fn drop(&mut self) {
        ...
        match *self.inner {
            ...
            ValidatorStartProgress::DownloadingSnapshot { slot, rpc_addr, total_bytes, current_bytes, elapsed_secs, estimated_time_remaining_secs, throughput_bytes_sec, full_snapshot } => {
                ...
                warn!("rpc_addr: {:?}, total, current, elapsed, estimated, throughput: {}, {}, {}, {}, {}", rpc_addr, total_bytes, current_bytes, elapsed_secs, estimated_time_remaining_secs, throughput_bytes_sec);
