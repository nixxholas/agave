use {
    ...
    rayon::prelude::*,
    solana_core::validator::{VSPRwLock, ValidatorConfig, ValidatorStartProgress},
    ...
    *start_progress.write().unwrap() = ValidatorStartProgress::DownloadingSnapshot {
    ...
    download_snapshot_archive(
        ...
        &mut Some(Box::new(move |download_progress: &DownloadProgressRecord| {
            ...
            *start_progress.write().unwrap() = ValidatorStartProgress::DownloadingSnapshot {
                slot: desired_snapshot_hash.0,
                rpc_addr: rpc_contact_info.rpc().unwrap_or(SocketAddr::new(IpAddr::V4(Ipv4Addr::new(0, 0, 0, 0)), 0)),
