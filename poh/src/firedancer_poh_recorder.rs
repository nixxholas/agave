...
extern "C" {
    ...
    fn fd_ext_poh_update_active_descendants(active_descendants_len: usize, active_descendants: *const u64);
}
...
impl PohRecorder {
    ...
    pub fn update_start_bank_active_descendants(&mut self, active_descendants: &[Slot]) {
        unsafe { fd_ext_poh_update_active_descendants(active_descendants.len(), active_descendants.as_ptr()) };
    }
