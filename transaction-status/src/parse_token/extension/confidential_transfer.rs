...
pub(in crate::parse_token) fn parse_confidential_transfer_instruction(
        ...
        .map_err(|_| ParseInstructionError::InstructionNotParsable(ParsableProgram::SplToken))?
    {
        ...
        ConfidentialTransferInstruction::Withdraw => {
            ...
            let equality_proof_instruction_offset: i8 = withdrawal_data.equality_proof_instruction_offset;
        ...
        ConfidentialTransferInstruction::Transfer => {
            ...
            let equality_proof_instruction_offset: i8 = transfer_data.equality_proof_instruction_offset;
            let ciphertext_validity_proof_instruction_offset: i8 = transfer_data.ciphertext_validity_proof_instruction_offset;
